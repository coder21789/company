    ...
    return (
      <g>
        <animateMotion
          ...
          // rotate="auto"
        >
          <mpath xlinkHref="#Path-20" />
        </animateMotion>
        <g transform="translate(-389.490837, -250.014429)">
          <g id="Group-3-Copy" transform="translate(389.490837, 138.014429)">
            ...
            <g id="Oval-3" strokeDasharray="1.35865387916565,6.793269395828247">
              <use fill="black" fillOpacity="1" filter="url(#filter-26)" xlinkHref="#path-25" />
              <use stroke="#6BAB09" strokeWidth="8.15192294" xlinkHref="#path-25" />
            </g>
            <path
